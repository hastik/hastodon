...
final class DeferredContent
{
	...
	private function buildJsCss(): string
	{
		$css = array_map('file_get_contents', array_merge([
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/reset.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Bar/assets/bar.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/toggle.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/table-sort.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/tabs.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Dumper/assets/dumper-light.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Dumper/assets/dumper-dark.css',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../BlueScreen/assets/bluescreen.css',
		], Debugger::$customCssFiles));

		$js1 = array_map(fn($file) => '(function() {' . file_get_contents($file) . '})();', [
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Bar/assets/bar.js',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/toggle.js',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/table-sort.js',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../assets/tabs.js',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../Dumper/assets/dumper.js',
			'C:/Dropbox/laragon/www/todo/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Debugger' . '/../BlueScreen/assets/bluescreen.js',
		]);
